...
1. **Push** — an operator runs `c17 push --agent scout --body
...
```xml
<channel source="cmdcntr" thread="primary" from="operator-1" level="info" msg_id="msg-..." ts="04/15/26 14:23:45 UTC" ts_ms="1700000000000">
